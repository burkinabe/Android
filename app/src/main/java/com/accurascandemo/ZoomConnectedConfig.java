...
public class ZoomConnectedConfig {
    ...
    static String AppToken = "dBcUMvlXtcsK21sCwXCsWlIT3toLa8Uw";
...
//            "mAiAKKvCdIqe17bltZ/rfEoL3gPKEfLXeN549LTj3XBp0hvG4loQ6eC1E1tRzSkfGJD4GIVvR+j12gXAaftj3ahfYxioBH7F7HQxzmWkwDyn3bqU54eaiB7f0ftsPpWMceUaqkL2DZUvgN0efEJjnWy5y1/Gkq5GGWCROI9XG/SwXJ30BbVUehTbVcD70+ZF8QIDAQAB";
    ...
    static ZoomCustomization currentCustomization;
    ...
    static boolean shouldCenterZoomFrame = true;

    // Create ZoomCustomization object to modify look and feel
    static ZoomCustomization ZoomConnectedCustomization() {
    ...
    static void setIdealFrameSizeRatio(Activity activity, int appWidth) {
    ...
    static void centerZoomFrame(int appWidth, int appHeight) {
